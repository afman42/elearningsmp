          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <form action="<?= site_url('admin/update_mapel/'.$mapel->id);?>" method="post" class="p-3">
                      <div class="form-group">
                        <label>Mata Pelajaran</label>
                        
                        <input type="text" class="form-control" name="nama" placeholder="Masukan Mata Pelajaran" required value="<?= $mapel->nama; ?>">
                      </div>
                      <div class="form-group">
